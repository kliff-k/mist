...
<link rel="stylesheet" href="./assets/css/theme.min.css">
  <title>MisT - The innovative game store platform</title>
</head>
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xxl-4 py-8 py-xl-0">
        ...
        <div class="card smooth-shadow-md">
          ...
          <div class="card-body p-6">
            <div class="mb-4">
              <a href="index.php"><h2>MisT</h2></a>
              <p class="mb-6">Please enter your user information.</p>

            </div>
            <!-- Form -->
            <form action="services/register.php" method="post" onsubmit="validate()">
              <!-- Username -->
              <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nickname" class="form-control" name="nickname" placeholder="Nick Name" required="">
                </div>
              <!-- Email -->
              <div class="mb-3">
              ...
              <div>
                ...
                <div class="d-md-flex justify-content-between mt-4">
                  <div class="mb-2 mb-md-0">
                    <a href="sign-in.php" class="fs-5">Already member? Login </a>
                  </div>
                  <div>
